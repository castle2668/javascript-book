...
就像是我同時有「海報人」跟「Sealman」兩個名字，這兩個名字都指向我這個人（位址），這個方式叫做 By Reference。
...
Mutate 是一個電腦科學家決定的複雜詞彙，它就是改變某件事 (To Change Something) 的意思，就醬。

所以我們在 MDN 或是 Stack Overflow 看到別人說 "mutate an object" 或是 "mutate a value" 就是指改變它的意思，單純是字面上的意思。
